        ...
        init: function(c) {
            return this.each(function() {
                ...
                d.createInput = function() {
                    ...
                    j.bind("change", function() {
                        ...
                        if ((d.queue.count + l) > f.queueSizeLimit && f.queueSizeLimit !== 0) {
                            ...
                            //     alert("Please remove the current file before uploading another");
                            // }
                ...
                if (f.itemTemplate == false) {
                    // d.queueItem = b('<div class="uploadifive-queue-item">                        <a id="close_file" class="close" href="#">X</a>                        <span><span class="filename"></span><span class="fileinfo"></span></span>                                                   </div>');
                    d.queueItem = b('<div class="uploadifive-queue-item">                                               <span><span class="filename"></span><span class="fileinfo"></span></span>                                                   </div>');
                } else {
                ...
                d.progress = function(l, j) {
                    if (b.inArray("onProgress", f.overrideEvents) < 0) {
                        ...
                        if(k<100)
                            ...
                            j.queueItem.find(".fileinfo").html(" - " + k + "% - Importing...");
